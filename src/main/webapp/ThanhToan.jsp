...
<section class="main-container">
    <div class="payment-section">
        ...
        <div class="payment-option">
            ...
            <div class="icon"><img src="IMAGE/asset/images/QR.png" alt="QR Code"/></div>
        ...
        <div class="payment-option">
            ...
            <div class="icon"><img src="IMAGE/asset/images/office.png" alt="office"/></div>
        ...
        <p class="note">Bằng việc thanh toán, Quý khách đồng ý rằng dữ liệu cá nhân sẽ được xử lý theo <a href="http://localhost:63342/Nhom15_LTWeb/DieuKienDieuKhoan.html?_ijt=u298ddfhl2r9h36eqvt6h38aqp&_ij_reload=RELOAD_ON_SAVE">Điều khoản sử dụng</a>.</p>

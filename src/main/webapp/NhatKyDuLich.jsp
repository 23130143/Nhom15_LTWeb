...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/Css/NhatKyDuLich.css">
</head>
<body>
<section id="header">
...
<section class="main-container">
    <div class="main-content">
        <div class="main-header">
            <h3>Hành Trình Khám Phá Tour Du Lịch Tháng 10</h3>
            <div class="time-post">
                <i class="fa-solid fa-clock"></i>
                <span id="today-date">11/2025</span>
        ...
        <div class="blog-list">
            <div class="blog">
                <img src="${pageContext.request.contextPath}/IMAGE/asset/images/Nam%20Kinh.jpg" alt="Nam Kinh"/>
                <div class="blog-content">
                    <h3>HÀNH TRÌNH KHÁM PHÁ DU LỊCH NAM KINH - VÔ TÍCH - Ô TRẤN - THƯỢNG HẢI</h3>
                    <div class="time-post">
                        <i class="fa-solid fa-clock"></i>
                        <span id="date1">31/10/2025</span>
                        <i class="fa-solid fa-user"></i>
                    </div>
                </div>
            </div>
            ...
            <div class="blog">
                <img src="${pageContext.request.contextPath}/IMAGE/asset/images/Tho%20Nhi%20Ky.jpg" alt="Thổ Nhĩ Kỳ"/>
                <div class="blog-content">
                    <h3>Hành Trình Khám Phá Du Lịch Thổ Nhĩ Kỳ</h3>
                    <div class="time-post">
                        <i class="fa-solid fa-clock"></i>
                        <span id="date2">25/10/2025</span>
                        <i class="fa-solid fa-user"></i>
                    </div>
                </div>
            </div>

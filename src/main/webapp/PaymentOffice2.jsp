...
<head>
    <meta charset="UTF-8">
    <title>Title</title>
    <link rel="stylesheet" href="Css/PaymentOffice.css">
...
<section class="main-container">
    ...
    <div class="main-img">
        <img src="IMAGE/asset/images/ThanhToanThanhCong.png" alt="success"/>
    </div>
    ...
    <div class="main-text">
        ...
        <div class="main-location">
            ...
            <span>Giảng đường Phượng Vỹ, khu phố 33, Phường Linh Xuân, TP.Hồ Chí Minh.</span>
        </div>
    ...
    <div class="main-button">
        <button class="btn-confirm" onclick="window.location.href='http://localhost:63342/Nhom15_LTWeb/Tour.html?_ijt=5vsd5k6ge3rent6bs7uo0esfn7&_ij_reload=RELOAD_ON_SAVE'">Quay về trang chủ</button>
    </div>
</section>

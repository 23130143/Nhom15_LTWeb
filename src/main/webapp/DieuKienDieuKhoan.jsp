...
<head>
    <meta charset="UTF-8">
    <title>Title</title>
    <link rel="stylesheet" href="Css/DieuKienDieuKhoan.css">
    ...
    <div class="main-content">
        ...
        <div class="main-content1">
            ...
            <p> - Phí dịch vụ: Là khoản phí TravelNow thu nhằm bù đắp chi phí vận hành, tư vấn và hỗ trợ khách hàng.
                Khoản
                phí này không hoàn lại trong mọi trường hợp</p>
        ...
        <div class="main-content2">
            ...
            <p>Người dùng phải từ 18 tuổi trở lên để được phép đặt dịch vụ qua TravelNow. Người dưới 18 tuổi chỉ được
                phép
                sử dụng khi có sự đồng ý của người giám hộ hợp pháp.</p>
        </div>
        ...
        <div class="main-content7">
            ...
            <p> - TravelNow không chịu trách nhiệm với các sai lệch, lỗi kỹ thuật, hình ảnh minh họa, hoặc thay đổi từ
                nhà
                cung cấp.</p>
        ...
        <div class="main-content11">
            ...
            <p>Các Điều kiện & Điều khoản này được điều chỉnh theo pháp luật Việt Nam. Chúng tôi nhận những thanh toán
                ...
                xin
                Quý Khách tham khảo Chính sách quyền cá nhân.</p>
        </div>
    </div>
</section>

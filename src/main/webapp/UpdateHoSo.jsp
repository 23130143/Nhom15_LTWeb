...
<head>
    <meta charset="UTF-8">
    <title>Title</title>
    <link rel="stylesheet" href="Css/updateHoSoStyle.css">
</head>
<body>
<section id="header">
...
<main id="main">
    ...
    <section class="profile-btn">
        <div class="update">
            <a href="http://localhost:63342/Nhom15_LTWeb/HoSo.html?_ijt=elipek9ebrhi1kjo2jr7nnfl6v&_ij_reload=RELOAD_ON_SAVE" class="update-btn">
                Chỉnh sửa hồ sơ
            </a>
        </div>
    </section>

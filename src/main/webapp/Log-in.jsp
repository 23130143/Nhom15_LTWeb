    ...
    <div class="login_form">
        <div class="login_frame">
            ...
            <div class="login_form_acc">
                ...
                <input id="gmail" class="login_input" type="email" placeholder="">
            </div>
            <div class="login_form_psw">
                <label for="psw">Mật khẩu</label>
                <input id="psw" class="login_input" type="password" placeholder="">
            ...
            <div class="btn">
                <a href="http://localhost:63342/Nhom15_LTWeb/HomeDaDangNhap.html?_ijt=i1qu2vani4itjddujf743tl6dv&_ij_reload=RELOAD_ON_SAVE"
                   class="login_btn">Đăng nhập</a>
            </div>

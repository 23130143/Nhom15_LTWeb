...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/Css/ChiTietNhatKy.css">
</head>
<body>
<section id="header">
...
<section class="main-container">
    <div class="main-content">
        <div class="main-header">
            ...
            <div class="main-header">
                <h4>Khởi hành: 23/10 - 27/10</h4>
                <h4>TL: Thành Trung</h4>
            </div>
        </div>

        <div class="main-image">
            <img src="<%= request.getContextPath() %>/IMAGE/asset/images/ChiTietNhatKy1.webp" alt="ảnh 1"/>
            <img src="<%= request.getContextPath() %>/IMAGE/asset/images/ChiTietNhatKy2.webp" alt="ảnh 2"/>
            <img src="<%= request.getContextPath() %>/IMAGE/asset/images/ChiTietNhatKy3.webp" alt="ảnh 3"/>
        </div>
    </div>
</section>
...
<script src="<%= request.getContextPath() %>/Javascript/ChiTietNhatKy.js"></script>
</body>
</html>
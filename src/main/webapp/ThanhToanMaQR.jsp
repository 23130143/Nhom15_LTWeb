...
<head>
    ...
    <link rel="stylesheet" href="Css/ThanhToanMaQR.css">
</head>
<body>
<section id="header">
...
<section class="main-container">
    ...
    <div class="main-content">
        <div class="QR">
            ...
            <img src="IMAGE/asset/images/QR-Bank.png" alt="QR-Bank"/>
        </div>
    ...
    <div class="success">
        <button class="btn-confirm" onclick="window.location.href='PaymentOnline.html'">Tôi đã chuyển khoản</button>
...
<script src="Javascript/NutCopy.js"></script>
</body>
</html>
